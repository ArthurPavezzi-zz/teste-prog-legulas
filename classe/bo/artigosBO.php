...
class artigosBO {
    ...
    $query = "INSERT INTO $this->table VALUES (NULL, :titulo, :descricao, :capa, :imagem);";
	...
	function Edit(artigosVO $artigos) {

		$pdo = new MyPDO();

		$titulo = $artigos->getTitulo();
		$descricao = $artigos->getDescricao();
		$id = $artigos->getId();
	...
	function Get($id) {
		...
		$query = "SELECT * FROM artigos WHERE artigos.id = $id";
